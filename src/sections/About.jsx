...
export default function About() {
  return (
    <section id="about" className="py-20 md:py-32 bg-offwhite relative overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
          <div>
            <RevealUp>
              <div className="text-sm font-bold uppercase tracking-[0.3em] text-forest/40 mb-6 md:mb-8">
                About Our Legacy
              </div>
            </RevealUp>
            
            <RevealUp delay={0.1}>
              <h2 className="font-display text-forest mb-8 md:mb-12" style={{ fontSize: 'clamp(2rem, 6vw, 3.75rem)' }}>
                Legacy of <span className="italic text-gold">The Land</span>
              </h2>
            </RevealUp>

            <RevealUp delay={0.2}>
              <p className="text-base md:text-xl font-sans text-forest/70 leading-relaxed max-w-xl">
              ...
              <p className="mt-5 md:mt-6 text-base md:text-lg font-sans text-forest/60 max-w-xl">
