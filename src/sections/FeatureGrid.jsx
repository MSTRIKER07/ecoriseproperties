...
export default function FeatureGrid() {
  ...
  return (
    <section id="features" className="py-20 md:py-32 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10" ref={ref}>
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="flex flex-col justify-center">
          <div className="lg:sticky lg:top-32">
            <motion.h3 
              ...
              className="font-bold tracking-tight text-primary-light mb-6 leading-tight"
            ...
            <motion.p 
              ...
              className="text-base md:text-lg text-zinc-400 mb-10 md:mb-16 max-w-md font-light"
            >
              Our proprietary platform integrates local registry data with real-time analytics to ensure zero-risk acquisitions.
            </motion.p>

            <div className="grid grid-cols-2 gap-x-6 md:gap-x-8 gap-y-8 md:gap-y-12">
              {features.map((feature, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl glass-panel flex items-center justify-center group-hover:border-emerald-highlight transition-colors duration-300 flex-shrink-0">
                      <Icon className="w-4 h-4 md:w-5 md:h-5 text-zinc-400 group-hover:text-emerald-highlight transition-colors duration-300" />
                    </div>
                    <span className="text-sm md:text-base text-primary-light font-medium group-hover:text-emerald-highlight transition-colors duration-300">{feature.label}</span>
                  </motion.div>
                );
              })}
            </div>
        ...
        <motion.div 
          ...
          className="relative rounded-[2.5rem] overflow-hidden group bg-zinc-900 border border-white/5"
          style={{ minHeight: 400, height: 'clamp(400px, 60vw, 800px)' }}
        >
          <img 
          ...
          <div className="absolute bottom-6 sm:bottom-12 left-4 sm:left-12 right-4 sm:right-12 glass-panel rounded-3xl p-5 sm:p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-700 ease-out">
            <div className="flex justify-between items-center mb-5 md:mb-8">
              <h4 className="text-base md:text-lg font-bold text-primary-light tracking-tight">Land Analysis</h4>
